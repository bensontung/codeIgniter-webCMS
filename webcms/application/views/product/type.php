                ...
                <div class="box  box-primary">
                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-hover">
                            ...
                            <?php endforeach; ?>
                            <?php echo form_open('/product/type'); ?>
                            <tr>
...
<div class="modal fade" id="editModal" tabindex="-2" role="dialog"  aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" id="editForm" method="post" accept-charset="utf-8" action="<?php echo base_url('/product/type/edit/'); ?>" onsubmit="return validate_form(this)">
                <div class="modal-header">
                    <button type="button" class="close"
                            data-dismiss="modal" aria-hidden="true">
                        &times;
...
<script>
    ...
    function delType(){
        location.href ="<?php echo base_url('/product/type/del/'); ?>"+"/"+delId;
    }
