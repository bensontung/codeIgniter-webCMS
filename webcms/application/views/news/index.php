            ...
            <div class="col-xs-12">
                <div class="box  box-primary">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <form  id="searchForm" method="post" accept-charset="utf-8" action="<?php echo base_url('/news/search/'); ?>" >
                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url('/news/edit/'.$list_item['id']); ?>">编辑</a></td>
                            </tr>
                            <?php endforeach; ?>
                        </table>
                    </div>
